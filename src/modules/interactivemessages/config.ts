...
/** Une URL http(s) exploitable comme bouton de lien. */
...
const buttonSchema = z.object({
  ...
  // Validé ici (et non plus à la saisie dans le panneau Discord) : une URL
  // invalide ferait rejeter tout le message par Discord à la publication.
  url: z
    .string()
    .max(512)
    .nullable()
    .default(null)
    .refine((value) => value === null || value === '' || isValidHttpUrl(value), {
